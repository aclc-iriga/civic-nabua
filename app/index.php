...
$routes = [
    ...
    [ "name" => "Tabulation", "route" => "http://localhost/civic-nabua" ],
    ...
    <div class="container d-flex align-items-center justify-content-center" style="min-height: 100vh;" >
        <div>
            <div class="text-center mb-5" >
                ...
                <h1 class="fw-bold" >civic-nabua</h1>
                <p class="fst-italic" >Annual Civic Street Parade (Nabua, Camarines Sur)</p>
            </div>
